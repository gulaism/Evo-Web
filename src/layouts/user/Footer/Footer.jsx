      ...
      <div className="container">
        <div className={styles.aboveCont}>
          ...
          <div>
            ...
            <div className={styles.subHeadingCont}>
              <a href="mailto:evolearningcenter@gmail.com" className={styles.contactCont}>
                <div className={styles.iconCont}>
                  <img className={styles.iconImg} src={email} alt="evo academy email address" />
                </div>
                <div>evolearningcenter@gmail.com</div>
              </a>
              <a href="tel:+994 55 773 34 52" className={styles.contactCont}>
                <div className={styles.iconCont}>
                  <img className={styles.iconImg} src={phone} alt="evo academy email address" />
                </div>
                <div>+994 55 773 34 52</div>
              </a>
              <a href="https://www.google.com/maps/search/?api=1&query=Evo+Academy" className={styles.contactCont}>
                <div className={styles.iconCont}>
                  <img className={styles.iconImg} src={address} alt="evo academy email address" />
                </div>
        ...
        <div className={styles.belowCont}>
          ...
          <div className={styles.socialCont}>
            <div className={styles.iconCont}>
              <img className={styles.iconImg} src={wp} alt="contact with whatsapp" />
            </div>
            <div className={styles.iconCont}>
              <img className={styles.iconImg} src={instagram} alt="contact with instagram" />
            </div>
            <div className={styles.iconCont}>
              <img className={styles.iconImg} src={yt} alt="youtube channel" />
            </div>
            <div className={styles.iconCont}>
              <img className={styles.iconImg} src={linkedIn} alt="contact with linkedIn" />
            </div>
            <div className={styles.iconCont}>
              <img className={styles.iconImg} src={fb} alt="contact with facebook" />
            </div>
          </div>
        </div>
      </div>
